...
const IconFont = createFromIconfontCN(
    '//at.alicdn.com/t/c/font_3784684_dtd2e5mepsf.js'
)

const content =
    'React Vant 是一套轻量、可靠的移动端 React 组件库'
    ...
    return (
        <>
                    ...
                    <Card className={styles.addressCard}>
                        <Flex align='center' justify="around">
                            ...
                            <Flex.Item className={styles.addressInfo}>
                                <Typography.Title level={6}>肯德基先生 <span>13935890089</span></Typography.Title>
                ...
                >
                    <Card className={styles.addressCard}>
                        <Flex align='center' justify="around">
                            ...
                            <Flex.Item className={styles.addressInfo}>
                                <IconFont name='icon-bianji' onClick={() => {
                                    Toast.info('点击来编辑')
                                }} />
                            </Flex.Item>
                        </Flex>
            ...
            <ActionBar safeAreaInsetBottom style={{ padding: '16px' }}>
                <Button round color='linear-gradient(to right, #ff6034, #ee0a24)' block icon={<IconFont name='icon-tongyong_tianjia' />}>
                    新建收获地址
                </Button>
            </ActionBar>
        </>
