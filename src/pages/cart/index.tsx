  ...
  return (
    <div className={styles.cartNav}>
      ...
      >
        ...
        >
          <Checkbox name={{ a: 1 }}>
            <ProductCard className={styles.cartProductCard} lazyload num={2} price="2.00" originPrice="10.00" desc="描述信息" title="商品名称" thumb={<Image lazyload src="https://react-vant.3lang.dev/demo_avatar_1.jpg"></Image>} />
          </Checkbox>
        </SwipeCell>
      </Checkbox.Group>
